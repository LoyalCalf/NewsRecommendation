...
def NBpredict():
    ...
    for k, v in feature_dict.items():
        ...
        dic = {'news_id': k, 'news_entertainment': proba[0], 'news_fashion': proba[1], 'news_finance': proba[2],
               'news_game': proba[3], 'news_society': proba[4], 'news_sports': proba[5], 'news_tech': proba[6]}
        update_data(dic)
